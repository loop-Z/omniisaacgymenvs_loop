...
class VisualPin(XFormPrim, Pin):
    ...
    def __init__(
        ...
        # translation=(0, 0, 0),
        # name="visual_pin",
        # ball_radius=1.0,      # ← 原来是 0.2，改成 1 m
        # poll_radius=0.02,     # ← 原来是 0.025，改成 0.02 m
        # poll_length=0.02,     # ← 原来是 2，改成 0.02 m
        # color=(1, 0, 0),
        ...
        # translation: Optional[Sequence[float]] = None,
        # color: Optional[np.ndarray] = None,
        # ball_radius: Optional[float] = 1.0,      # ← 原来是 0.2 → 1 m
        # poll_radius: Optional[float] = 0.02,     # ← 原来是 0.025 → 0.02 m
        # poll_length: Optional[float] = 0.02,     # ← 原来是 2 → 0.02 m
        # visual_material: Optional[VisualMaterial] = None,
